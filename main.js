...
const booksApp = function () {
    ...
    const createTable = function () {
        ...
        for (let i = 0; i < this.myBooks.length; i++) {
            ...
            save.setAttribute('id', 'Save' + i);
            save.setAttribute('style', 'display:none;');
            // save.setAttribute('onclick', Save()); // ADD THE BUTTON's 'onclick' EVENT.
            this.td.appendChild(save);
            ...
            update.setAttribute('id', 'Edit' + i);
            update.setAttribute('style', 'background-color:#44CCEB;');
            // update.setAttribute('onclick', Update()); // ADD THE BUTTON's 'onclick' EVENT.
            this.td.appendChild(update);
            ...
            btDelete.setAttribute('value', 'Delete');
            btDelete.setAttribute('style', 'background-color:#ED5650;');
            // btDelete.setAttribute('onclick', Delete()); // ADD THE BUTTON's 'onclick' EVENT.
            this.td.appendChild(btDelete);
        }
        ...
        btNew.setAttribute('type', 'button'); // SET ATTRIBUTES.
        btNew.setAttribute('id', 'butt');
        btNew.setAttribute('value', 'Create');
        btNew.setAttribute('style', 'background-color:#207DD1;');
        btNew.setAttribute('onclick', CreateNew()); // ADD THE BUTTON's 'onclick' EVENT.
        this.td.appendChild(btNew);
    ...
    const CreateNew = function () {
        ...
        if (obj !== '') {
>>>>>>> 94ace0f43fb437b264ab7b02fb0e252a60de2d3b
...
=======
    ...
    let Cancel = function () {
        for (let i = 0; i < this.myBooks.length; i++){
        const button = document.querySelector('#cancel' + i)
